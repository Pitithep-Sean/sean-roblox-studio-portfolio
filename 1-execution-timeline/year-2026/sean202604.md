...
<details style="display:inline-block; width:100%;">
	  <summary style="list-style:none; cursor:pointer; outline:none;">
	    <img src="./assets/202604-assets/sean2604-constr1-a.jpg" alt="Click to scan code" width="100%" style="transition: opacity 0.2s; border-radius: 4px;" onmouseover="this.style.opacity='0.8'" onmouseout="this.style.opacity='1'">
	 <!--   <div style="text-align:center; font-size:12px; color:#888; margin-top:4px;">🔍 Click image to isolate and expand code viewer</div>-->
		 <span style="display:block; text-align:center; font-size:12px; color:#888; margin-top:4px;">🔍 Click image to isolate and expand code viewer</span>
	</summary>
		<div style="position:fixed; top:0; left:0; width:100vw; height:100vh; background:rgba(10,10,10,0.95); z-index:99999; display:flex; align-items:center; justify-content:center; cursor:zoom-out;" onclick="this.parentElement.removeAttribute('open');">
...
<details style="display:inline-block; width:100%;">
	  <summary style="list-style:none; cursor:pointer; outline:none;">
	    <img src="./assets/202604-assets/sean2604-constr1-b.jpg" alt="Click to scan code" width="100%" style="transition: opacity 0.2s; border-radius: 4px;" onmouseover="this.style.opacity='0.8'" onmouseout="this.style.opacity='1'">
	 <!--   <div style="text-align:center; font-size:12px; color:#888; margin-top:4px;">🔍 Click image to isolate and expand code viewer</div>-->
		 <span style="display:block; text-align:center; font-size:12px; color:#888; margin-top:4px;">🔍 Click image to isolate and expand code viewer</span>
	</summary>
		<div style="position:fixed; top:0; left:0; width:100vw; height:100vh; background:rgba(10,10,10,0.95); z-index:99999; display:flex; align-items:center; justify-content:center; cursor:zoom-out;" onclick="this.parentElement.removeAttribute('open');">
...
<tr>
 ...
 <table>
  <tr>
        <td width="50%">
          <b>Connecting Code to Interactive Game Systems</b>
          <img src="./assets/202604-assets/sec3-sean2604-humanoid-1.jpg" alt="Student note showing paper tracking entry" width="100%"></td>
</tr>
<tr>
