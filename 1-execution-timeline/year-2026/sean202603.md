...
<td width="50%"> <b>Tracking Lighting Properties</b><br> 
	<video src="./assets/others/sean2603-light-decal-b.mp4" autoplay loop muted playsinline width="100%" style="border-radius: 6px; cursor: pointer; box-shadow: 0 4px 10px rgba(0,0,0,0.3);" onclick="this.muted=false; if(this.requestFullscreen){this.requestFullscreen();}else if(this.webkitRequestFullscreen){this.webkitRequestFullscreen();}"> </video>
