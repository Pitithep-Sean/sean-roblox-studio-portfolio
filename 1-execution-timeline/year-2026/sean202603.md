...
<table>
  <tr>
    ...
    <td width="50%">
      <b>B</b><br>
      <img src="./assets/images/2026Mar/sean2603-1st-house-b.jpg" alt="Sean create first basic house" width="80%">
    </td>
  </tr>
  <tr>
    <td colspan="2" align="center">
      📷 <b><I>Caption:</I></b>Sean completed his first architectural construction project in Roblox Studio by following a structured building process from start to finish. During the project, he discovered that a small dimensional error in the floor thickness caused the entrance stairs to become misaligned. Rather than rebuilding the structure, he used scaling tools and prior knowledge to correct the issue. This milestone introduced an important engineering principle: small measurement errors can affect an entire system. 
    </td>
  </tr>
  <tr>
    <td width="50%">
      <b>A</b><br>
      <img src="./assets/images/2026Mar/sean2603-mcdonald-a.jpg" alt="Sean create first basic house" width="80%">
    </td>
    <td width="50%">
      <b>B</b><br>
      <img src="./assets/images/2026Mar/sean2603-mcdonald-b.jpg" alt="Sean create first basic house" width="80%">
    </td>
  </tr>
  <tr>
    <td colspan="2" align="center">
      📷 <b><I>Caption:</I></b>While building a McDonald's-themed environment, Sean explored lighting effects and visual design through Roblox Studio's Properties system. He learned to compare parameter changes using a before-and-after approach, allowing him to identify which settings controlled brightness, angles, and atmosphere. By independently adjusting these variables, he transformed the environment to achieve his intended visual outcome. This milestone strengthened his observation skills and introduced the concept of iterative design through experimentation.
    </td>
  </tr>
