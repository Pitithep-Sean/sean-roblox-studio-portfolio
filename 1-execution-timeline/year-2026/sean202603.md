...
<table>
  <tr>
    <td width="50%">
      <b>A</b><br>
      <img src="./assets/images/2026Mar/sean2603-1st-house-a.jpg" alt="Sean create first basic house" width="100%">
    </td>
    <td width="50%">
      <b>B</b><br>
      <img src="./assets/images/2026Mar/sean2603-1st-house-b.jpg" alt="Sean create first basic house" width="100%">
    </td>
  </tr>
  <tr>
    <td colspan="2" align="center">
      📷 <b><I>Caption:</I></b>Sean completed his first house construction project in Roblox Studio. During the build, he discovered that an incorrect floor thickness caused the entrance stairs to become misaligned. Rather than rebuilding the structure, he corrected the dimensions using scaling tools and successfully restored the design. 
    </td>
  </tr>
  <tr>
    <td width="50%">
      <b>A</b><br>
      <img src="./assets/images/2026Mar/sean2603-mcdonald-a.jpg" alt="Sean create first basic house" width="100%">
    </td>
    <td width="50%">
      <b>B</b><br>
      <img src="./assets/images/2026Mar/sean2603-mcdonald-b.jpg" alt="Sean create first basic house" width="100%">
    </td>
  </tr>
  <tr>
    <td colspan="2" align="center">
