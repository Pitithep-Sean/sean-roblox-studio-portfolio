...
<table>
  ...
  <div style="position:fixed; top:0; left:0; width:100vw; height:100vh; background:rgba(10,10,10,0.95); z-index:99999; display:flex; align-items:center; justify-content:center; cursor:zoom-out;" onclick="this.parentElement.removeAttribute('open');">
    ...
    <td width="50%">
      <b>B</b><br>
    <a href="./assets/images/2026Mar/sean2603-while-for-loop-b1.jpg" target="_blank" title="Click to expand code in new tab">
  <img src="./assets/images/2026Mar/sean2603-while-for-loop-b1.jpg" alt="Sean is observing his color variables" width="100%" style="border-radius: 4px; transition: opacity 0.2s;" onmouseover="this.style.opacity='0.8'" onmouseout="this.style.opacity='1'">
</a>
<div style="text-align: center; font-size: 12px; color: #888; margin-top: 4px;">🔍 Click image to isolate and expand code viewer in a new tab</div>
    </td>
  </tr>
  <tr>
    <td colspan="2" align="center">
