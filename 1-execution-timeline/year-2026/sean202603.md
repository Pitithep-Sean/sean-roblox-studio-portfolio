...
<table>
  ...
  <tr>
    ...
    <td width="50%">
      <b>A</b><br>
      <img src="./assets/images/2026Mar/sean2603-while-for-loop-b1.jpg" alt="Sean is observing his color variables" width="100%" style="transition: transform 0.2s ease; cursor: zoom-in;" onmouseover="this.style.transform='scale(1.5)'; this.style.zIndex='999'; this.style.position='relative';" onmouseout="this.style.transform='scale(1)'; this.style.zIndex='1'; this.style.position='static';">
    </td>
    <td width="50%">
      <b>B</b><br>
